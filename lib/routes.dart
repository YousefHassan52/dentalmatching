...
import 'package:dentalmatching/features/common_faetures/change_profile_image/view/add_profile_img.dart';
...
import 'package:dentalmatching/features/doctor_features/edit_specialization/view/edit_specialization.dart';
...
List<GetPage> routes = [
  ...
  GetPage(
    name: AppRoutes.changeProfileImage,
    page: () => const AddProfileImgScreen(),
  ),
  GetPage(
  ...
  GetPage(
    name: AppRoutes.editSpecializationScreen,
    page: () => const EditSpecialization(),
  ),
];
