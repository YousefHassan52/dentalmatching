...
class LanguageSelection extends StatelessWidget {
  const LanguageSelection({super.key, required this.txt, required this.txt1, required this.txt2, required this.onPressed, required this.onPressed1, required this.onPressed2});
  final String txt;
  final String txt1;
  final String txt2;
